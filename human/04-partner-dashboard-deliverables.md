...
| Screenshot 1 | 1600x900 PNG, storefront try-on widget open | READY: `../../pics/screenshot1_widget_open_fixed.png` (storefront chrome painted out per AI review feedback) |
| Screenshot 2 | 1600x900 PNG, embedded admin dashboard | READY: `../../pics/screenshot2_admin_fixed.png` (pricing strings "Choose a plan" / "Pick a paid plan" painted out per AI review feedback) |
| Screenshot 3 | 1600x900 PNG, generated before/after result | READY: `../../pics/screenshot3_result_fixed.png` (storefront chrome painted out per AI review feedback) |
